...
*/
const myAge = 22
let freeAccessMessage = 'Para você, a entrada é grátis!'
let ticketValue = 'A entrada é R$ 30,00.'

// if (myAge <= 7 || myAge >= 65) {
//   console.log(freeAccessMessage)
// } else {
...
//   const isNumberBetween11And90 = number >= 11 && numbers[i] <= 90 
...
let crazyArrayStrings = 0
let crazyArrayNumbers = 0
let crazyArrayBooleans = 0
...
// console.log(`O crazyArray tem ${crazyArrayBooleans} booleans, ${crazyArrayNumbers} números e ${crazyArrayStrings} strings.`)
