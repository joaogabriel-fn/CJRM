...
// const inputPattern = /[a-zA-Z]{6,}/

// const createAndInsertParagraph = (elementId, afterElement) => {
//   const newParagraph = document.createElement('p')
//   newParagraph.setAttribute('id', elementId)
//   afterElement.insertAdjacentElement('afterend', newParagraph)
// }

// form.username.addEventListener('keyup', () => {
//   let inputFeedbackParagraph = document.querySelector('#input-feedback')
//   const inputValidation = inputPattern.test(form.username.value)

//   if (inputFeedbackParagraph === null) {
//     createAndInsertParagraph('input-feedback', input)
//     inputFeedbackParagraph = document.querySelector('#input-feedback')
//   }

//   if (inputValidation) {
//     inputFeedbackParagraph.setAttribute('class', 'username-success-feedback')
//     inputFeedbackParagraph.textContent = 'Username válido =)'
//     return
//   }

//   inputFeedbackParagraph.setAttribute('class', 'username-help-feedback')
//   inputFeedbackParagraph.textContent = 'Username inválido =)'
// })
...
//     createAndInsertParagraph('submit-feedback', button)
//     submitFeedback = document.querySelector('#submit-feedback')
//   }

//   const inputFeedbackParagraph = document.querySelector('#input-feedback')
//   const isInputValid = inputFeedbackParagraph.getAttribute('class') === 'username-success-feedback'
...
// PRIMEIRO METODO - REMOVENDO O PARAGRAPHA PARA EVITAR DUPLICAÇÃO
