...
// const includesLion = animals.includes('leão')
// let includesLionString = null

// if (!includesLion) {
//   includesLionString = 'Leão não existe no array animals.'
//   console.log(includesLionString)
// } else {
//   includesLionString = 'Existe um leão no array animals.'
//   console.log(includesLionString)
// }
...
//   const isNumberBiggerThan400 = randomNumbersSum > 400

//   if (isNumberBiggerThan400) {
...
// console.log(completeSentence.join(' '))
...
// const randomValues = [57, false, 'JS', [], true, 'HTML', 31, null, false, 'CSS', 97, true, 'Git', 'Teste', 11, 'sticker', false, 'GitHub', true, null]
// let randomValuesStrings = []
// let randomValuesBooleans = 0
// let randomValuesCount = 0

// for (let i = 0; i < randomValues.length; i++) {
//   const item = randomValues[i]
//   const typeOfItem = typeof item
//   const itemIsString = typeOfItem === 'string'
//   const itemIsBoolean = typeOfItem === 'boolean'
//   const stringCount = randomValuesStrings.length

//   if (stringCount === 4) {
//     break
//   } else if (itemIsBoolean) {
//     randomValuesBooleans++
...
// const lastItem = randomValuesStrings[randomValuesStrings.length - 1]
// const first4Strings = randomValuesStrings.join(', ').replace(`, ${lastItem}`, ` e ${lastItem}`)

// console.log(`3 informações sobre o array randomValues:
//   - As primeiras 4 strings são ${first4Strings};
//   - Até que as primeiras 4 strings fossem iteradas, ${randomValuesBooleans} booleans foram iterados;
//   - O array foi iterado por ${randomValuesCount} vezes;`
// )
